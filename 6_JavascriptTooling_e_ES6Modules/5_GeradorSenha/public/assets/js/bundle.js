...
var checkMaiuscula = document.querySelector('.chk-maiusculas');
var checkMinuscula = document.querySelector('.chk-minusculas');
var checkNumero = document.querySelector('.chk-numeros');
var checkSimbolo = document.querySelector('.chk-simbolos');
...
function gera() {
  return (0,_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qtdCaracteres.value, checkMaiuscula.checked, checkMinuscula.checked, checkNumero.checked, checkSimbolo.checked) || 'Nada selecionado.';
}
...
var geraMaiuscula = () => String.fromCharCode(rand(65, 91));
var geraMinuscula = () => String.fromCharCode(rand(97, 123));
var geraNumero = () => String.fromCharCode(rand(48, 58));
var simbolos = '!@#$%¨&*()_/-+={}|[/]^~`;.,<>?:';
var geraSimbolo = () => simbolos[rand(0, simbolos.length)];
